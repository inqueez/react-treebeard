...
var Toggle = function Toggle(_ref2) {
    var style = _ref2.style,
        onArrowClick = _ref2.onArrowClick;
    ...
    return _react2.default.createElement(
        'div',
        { className: 'Arrow', style: style.base, onClick: onArrowClick },
...
var Header = function Header(_ref3) {
    ...
    return _react2.default.createElement(
        'div',
        { style: style.base, onDoubleClick: onDoubleClick, onClick: onClick },
        _react2.default.createElement(
            'div',
            { style: style.title },
            node.name
...
var Container = function (_React$Component) {
    ...
    (0, _createClass3.default)(Container, [{
        ...
        value: function renderToggleDecorator() {
            ...
            return _react2.default.createElement(decorators.Toggle, { style: style.toggle, onArrowClick: onArrowClick });
        }
    }]);
    return Container;
